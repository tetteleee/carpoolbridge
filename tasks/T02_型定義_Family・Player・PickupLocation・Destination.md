# Task T02 型定義：Family・Player・PickupLocation・Destination

---

## 1. 対象設計書

ref: docs/05_データ設計.md#3 Family（家庭）、#4 Player（選手）、#5 PickupLocation（集合場所）、#6 Destination（目的地）

---

## 2. このタスクのゴール

マスタデータ4種（Family・Player・PickupLocation・Destination）のTypeScript型定義を作成する。
...
- `Family`・`Player`・`PickupLocation`・`Destination` の4つの型が定義されている
